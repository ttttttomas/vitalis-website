...
import TicketCard from "../../(pacientes)/soporte-pacientes/TicketCard";

export default function SoporteEmpresaPage() {
      ...
      <section className="flex flex-col gap-5 text-black">
        <div>
          ...
          <div className="mt-2 max-h-[300px] overflow-y-auto pr-2">
            {tickets.map((ticket) => (
              <TicketCard key={ticket.id} linkPrefix="/system/soporte-empresa" ticket={ticket} />
            ))}
            {tickets.length === 0 && (
